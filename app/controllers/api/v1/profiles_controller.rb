class Api::V1::ProfilesController < Api::V1::ApiController
	...
	def update_profile_params
		params.require(:profile).permit(:profile_picture, :current_job_title, :professional_title, :professional_overview, :youtube_video_link, :youtube_video_type, :hourly_rate, :availability,
