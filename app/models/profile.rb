class Profile < ApplicationRecord
	...
	validates :resume, :profile_type, :current_location_country , :current_location_city , :citizenship_country , :citizenship_full_name, presence: true
	validates :current_job_title, :about_me, presence: true
